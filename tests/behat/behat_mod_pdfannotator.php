...
class behat_mod_pdfannotator extends behat_base {
    ...
    /**
     * Adds a new pdfannotator to the specified course and section.
     *
     * @Given I add a pdfannotator to course :coursefullname section :sectionnum
     * @param string $coursefullname
     * @param int $sectionnumber
     * @return void
     */
    public function i_add_a_pdfannotator_to_course_section_and_fill_form(
        ...
        $this->execute(
            ...
            ['pdfannotator', $this->escape($coursefullname), $this->escape($sectionnumber), $data]
        );
